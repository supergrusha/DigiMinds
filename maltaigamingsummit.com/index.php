...
<html>   
    <head>
        ...
        <meta name="description" content="Malta iGaming Summit 2013"> 
    ...
    <body>
        ...
        <div id="wrapper"> 
            ...
            <div class="content-wrapper">
                ...
                ?>                                         
                        <div class="news">   
                           <a href="news/index.php" style="border-bottom: none;">    
                               <h2 class="icon-rss"><?= $row['pageDet_name']; ?></h2></a>  
                            <div class="clear-both"></div>               
                            <ul>                       
          <?
                            $link = "http://maltaigamingsummit.com//news/news_item.php";
                            $count = 0;
                            ...
                            while ($row = $db->fetchData($result)) {
                                ...
                                ?>">                    
                                    ...
                                    <a href="<?= $link . "?id=" . $id ?>"><?= $row['news_title']; ?></a> 
                                    <p><?= $content; ?></p>             
                                    <a class="more" href="<?= $link . "?id=" . $id ?>">Read More</a>  
                                </li>                                   
                              <? 
                              $count++;                             
                            }
